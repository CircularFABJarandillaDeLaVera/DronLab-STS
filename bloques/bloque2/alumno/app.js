  ...
  function ficha() {
    ...
    m.innerHTML = `
      ...
      <section class="panel columns">
        ...
        <div><h2>Datos criticos</h2><ul><li>Aptitud medica y estado general de salud.</li><li>Sustancias psicoactivas: alcohol, medicinas y drogas.</li><li>Fatiga y ritmo circadiano.</li><li>Estres y presion comercial.</li><li>Consciencia situacional.</li><li>BVLOS y observadores.</li><li>Barrido visual de 10 a 15 grados.</li><li>Motricidad fina degradada por frio extremo.</li></ul></div>
      </section>
      <section class="panel columns">
